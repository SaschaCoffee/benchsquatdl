...
public class listAllProfilesAdapter extends RecyclerView.Adapter<listAllProfilesViewHolder>{
    ...
    public listAllProfilesAdapter(ArrayList<String> benchList, ArrayList<String> squatList, ArrayList<String> deadliftList, ArrayList<String> nameList, ArrayList<String> cityList) {
