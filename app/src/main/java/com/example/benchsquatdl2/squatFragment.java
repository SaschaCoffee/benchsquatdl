...
public class squatFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pgBar = vx.findViewById(R.id.progressBar3);
        tv = vx.findViewById(R.id.text_view_progress_squat);


        referenceTraininglogPublic = FirebaseDatabase.getInstance().getReference("TraininglogPublic");

        mRecyclerView = vx.findViewById(R.id.recyclerview_squat);
        String childcard = "anzahlSquat";
        String childcardBench = "Best3SquatKg";
        ...
        bre = vx.findViewById(R.id.btn_add_data_card_squat);
                        ...
                        switch(save.size()){
                            ...
                            case 1:
                                ...
                                if(!first_kg_string.isEmpty() && !first_rep_string.isEmpty()) {
                                    modelSquat squat1 = new modelSquat(first_rep_string, first_kg_string, date, dummyTxt);
                                    referenceTraininglogPublic.child(keyTraining).setValue(squat1);
                            ...
                            case 3:
                                ...
                                if(!first_rep_l3.isEmpty() && !second_rep_l3.isEmpty() &&
                                    ...
                                    modelSquat squat3 = new modelSquat(first_rep_l3, second_rep_l3, third_rep_l3, first_kg_l3, second_kg_l3, third_kg_l3, date, dummyTxt);
                            ...
                            case 5:
                                ...
                                if(!rp1_l5.isEmpty() && !rp2_l5.isEmpty() && !rp3_l5.isEmpty() && !rp4_l5.isEmpty() && !rp5_l5.isEmpty() &&
                                    ...
                                    modelSquat squat5 = new modelSquat(rp1_l5, rp2_l5, rp3_l5, rp4_l5, rp5_l5, kg1_l5, kg2_l5, kg3_l5, kg4_l5, kg5_l5, date, dummyTxt);
